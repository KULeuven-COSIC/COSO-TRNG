"""Generate estimated min-entropy and HTP versus delta and C figure for SmartFusion 2."""
import argparse
import sys
import csv
...
store_data = s_d.StoreData(name='h_vs_csc_sf2')
...
graph_maker = g_m.GraphMaker('h_vs_csc_sf2.svg', figure_size=(1, 1), folder_name='figures')
graph_maker.create_grid(size=(3, 1), y_ratios=[1, 0, 1],
                        marg_mid_hor=0, marg_mid_ver=0, marg_top=0.77, marg_left=0.13,
                        marg_bot=0.16)
